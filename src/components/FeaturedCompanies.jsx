  ...
  return (
    <section className="px-12 py-16 bg-white">
      ...
      <div className="relative">
        ...
        <div
          ref={scrollRef}
          className="flex gap-6 overflow-x-auto scroll-smooth pb-4 px-10 scrollbar-hide snap-x snap-mandatory"
        >
            
          {companies.map((company, index) => (
            <div
              key={index}
              className="min-w-[280px] bg-white border border-gray-200 rounded-2xl p-6
            ...
            >
              ...
              <div className="mt-3 bg-gray-100 rounded-lg px-3 py-2 text-sm flex gap-2 items-center">
              ...
              <button className="mt-5 px-4 py-2 text-green-600 bg-green-50 rounded-full hover:bg-green-100 transition">
                View jobs
              </button>
            </div>
          ))}
       ...
       <div className="text-center mt-14">
        <button className="px-7 py-3 border border-blue-500 text-blue-600
