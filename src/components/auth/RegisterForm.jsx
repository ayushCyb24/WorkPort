    ...
    <div className="w-full max-w-6xl mx-auto bg-white rounded-xl shadow flex flex-col md:flex-row overflow-hidden">
      <div className="w-full md:w-2/3 p-5 sm:p-6 md:p-8 space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          <button className="w-full md:flex-1 bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700 transition">
            Register
          </button>

          <span className="text-xs sm:text-sm text-gray-500">OR</span>

          <button className="w-full md:flex-1 border py-3 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-100 transition">
            <img
